...
var ScrollAreaViewport = React5.forwardRef(function ScrollAreaViewport2(componentProps, forwardedRef) {
  const {
    render,
    className,
    ...elementProps
  ...
  const programmaticScrollRef = React5.useRef(true);
  const lastMeasuredViewportMetricsRef = React5.useRef([NaN, NaN, NaN, NaN]);
  ...
  const viewportState = React5.useMemo(() => ({
    scrolling: scrollingX || scrollingY,
    hasOverflowX: !hiddenState.x,
    hasOverflowY: !hiddenState.y,
    overflowXStart: overflowEdges.xStart,
...
var ScrollAreaScrollbarContext = React6.createContext(void 0);
if (true) ScrollAreaScrollbarContext.displayName = "ScrollAreaScrollbarContext";
function useScrollAreaScrollbarContext() {
  const context = React6.useContext(ScrollAreaScrollbarContext);
  if (context === void 0) {
...
var ScrollAreaScrollbar = React7.forwardRef(function ScrollAreaScrollbar2(componentProps, forwardedRef) {
  const {
    render,
    className,
...
var ScrollAreaContent = React8.forwardRef(function ScrollAreaContent2(componentProps, forwardedRef) {
  const {
    render,
    className,
    ...elementProps
  } = componentProps;
  const contentWrapperRef = React8.useRef(null);
  const {
    computeThumbPosition
...
var ScrollAreaThumb = React9.forwardRef(function ScrollAreaThumb2(componentProps, forwardedRef) {
  const {
    render,
    className,
    ...elementProps
...
var ScrollAreaCorner = React10.forwardRef(function ScrollAreaCorner2(componentProps, forwardedRef) {
  const {
    render,
    className,
    ...elementProps
